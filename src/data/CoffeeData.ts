const CoffeeData = [
  {
    id: 'C1',
    name: 'Gin',
    description: `Gin Wine is a sophisticated blend that marries the botanical richness of gin with the refined complexity of fine wine. This unique beverage offers an innovative experience for those who appreciate the intricate flavors of gin and the elegant notes of wine. Each sip of Gin Wine reveals a harmonious balance, where the aromatic juniper and botanical essences of gin seamlessly blend with the fruity, tannic qualities of wine. Perfect for a variety of occasions, Gin Wine can be enjoyed neat, over ice, or as a refreshing component in cocktails. Its versatility and distinct flavor profile make it a standout choice for those looking to explore new and exciting beverages. Whether you're a gin aficionado or a wine enthusiast, Gin Wine promises a delightful and unexpected tasting experience.`,
    alcohol: 'Distillation',
    imagelink_square: require('../assets/wine_assets/gin/square/beefeater_blackberry_gin.png'),
    imagelink_portrait: require('../assets/wine_assets/gin/portrait/beefeater_blackberry_gin.png'),
    ingredients: 'Blackberries',
    special_ingredient: 'With Blackberries',
    prices: [
  ...
  },
  {
    ...
    description: `Gin Wine is a sophisticated blend that marries the botanical richness of gin with the refined complexity of fine wine. This unique beverage offers an innovative experience for those who appreciate the intricate flavors of gin and the elegant notes of wine. Each sip of Gin Wine reveals a harmonious balance, where the aromatic juniper and botanical essences of gin seamlessly blend with the fruity, tannic qualities of wine. Perfect for a variety of occasions, Gin Wine can be enjoyed neat, over ice, or as a refreshing component in cocktails. Its versatility and distinct flavor profile make it a standout choice for those looking to explore new and exciting beverages. Whether you're a gin aficionado or a wine enthusiast, Gin Wine promises a delightful and unexpected tasting experience.`,
    alcohol: 'Distillation',
    imagelink_square: require('../assets/wine_assets/gin/square/bombay_sapphire_gin.png'),
    imagelink_portrait: require('../assets/wine_assets/gin/portrait/bombay_sapphire_gin.png'),
    ingredients: 'Juniper Berries',
    special_ingredient: 'With Cubeb Berries',
    prices: [
      {size: 'S', price: '1.38', currency: '$'},
      {size: 'M', price: '3.15', currency: '$'},
      {size: 'L', price: '4.29', currency: '$'},
  ...
  },
  {
    ...
    description: `Gin Wine is a sophisticated blend that marries the botanical richness of gin with the refined complexity of fine wine. This unique beverage offers an innovative experience for those who appreciate the intricate flavors of gin and the elegant notes of wine. Each sip of Gin Wine reveals a harmonious balance, where the aromatic juniper and botanical essences of gin seamlessly blend with the fruity, tannic qualities of wine. Perfect for a variety of occasions, Gin Wine can be enjoyed neat, over ice, or as a refreshing component in cocktails. Its versatility and distinct flavor profile make it a standout choice for those looking to explore new and exciting beverages. Whether you're a gin aficionado or a wine enthusiast, Gin Wine promises a delightful and unexpected tasting experience.`,
    alcohol: 'Distillation',
    imagelink_square: require('../assets/wine_assets/gin/square/finsbury_london_dry.png'),
    imagelink_portrait: require('../assets/wine_assets/gin/portrait/finsbury_london_dry.png'),
    ingredients: 'Juniper Berries',
    special_ingredient: 'With Juniper Berries',
    prices: [
      {size: 'S', price: '1.38', currency: '$'},
      {size: 'M', price: '3.15', currency: '$'},
      {size: 'L', price: '4.29', currency: '$'},
